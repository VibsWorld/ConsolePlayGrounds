...
public class Program
{
    ...
    static async Task Main(string[] args)
    {
        ...
        await postgresTestContainer.StartContainer();

        Console.WriteLine(
            $"Postgres mapped dynamic Port is {postgresTestContainer.GetPostgreSqlContainer.GetMappedPublicPort(PostgreSqlBuilder.PostgreSqlPort)}"
        );
        ...
        await InitializeMigrations(postgresTestContainer.GetPostgreSqlContainer, testCaseResults);
        ...
        await postgresTestContainer.GetPostgreSqlContainer.DisposeAsync();
